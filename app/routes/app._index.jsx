...
//   // console.log("Billing ID obtained on the loader", billingId);
...
//   // console.log(
//   //   "Billing details of the users received on the index page",
//   //   billings,
//   // );
...
//     console.log("Shop data obtained on response", shopData);
...
//   const subscriptionUrl = "https://admin.shopify.com/store/quickstart-bc4fc407/charges/majik/pricing_plans";

//   // useEffect(() => {
//   //   console.log("Shop Details:", shop);
//   //   console.log("Subscription Details:", subscription);
//   //   console.log("Subscription name is", subscription.name);
...
//             </Layout.Section>
            ...
            //   <div className="indexpricing-container">
            //     <h1 className="indexpricing-title">Choose Your Plan</h1>
            //     <div className="indexpricing-cards">
            //       {/* Free Plan Card */}
            //       <div className="priceinfoarea">
            //         <div className="pricedata">
            //           <p>Majik-Basic</p>
            //           <h3>Free</h3>
            //           <div className="indexpricingdetail">
...
export default function Index() {
  ...
  const subscriptionUrl = `https://admin.shopify.com/store/${shopId}/charges/majik/pricing_plans`;
